...
image::https://miro.medium.com/max/1050/1*XpBtUckStpozzH5ZH3wX-w.png[width=300, float=right]
...
image::https://miro.medium.com/max/557/1*hvs9CFw5tCH9JkcDsLuu1Q.png[width=300, float=right]
