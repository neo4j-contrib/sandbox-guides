...
function render {
$GUIDES/run.sh osm_guide.adoc index.html +1 "$@"
}

if [ "$1" == "publish" ]; then
	URL=guides.neo4j.com/sandbox/openstreetmap
	render http://$URL -a csv-url=http://guides.neo4j.com/sandbox/openstreetmap/data/ -a env-training
  ...
  render http://$URL
	...
	URL=localhost:8001/sandbox/openstreetmap
