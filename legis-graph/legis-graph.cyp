...
FROM 'https://raw.githubusercontent.com/neo4j-contrib/sandbox-guides/master/legis-graph/data/legislators-current.csv' AS line
...
LOAD CSV WITH HEADERS
FROM 'https://raw.githubusercontent.com/neo4j-contrib/sandbox-guides/master/legis-graph/data/bills.csv'
AS line
...
LOAD CSV WITH HEADERS
FROM 'https://raw.githubusercontent.com/neo4j-contrib/sandbox-guides/master/legis-graph/data/subjects.csv' AS line
MERGE (subject:Subject { title: line.title });

// Load Congresses

LOAD CSV WITH HEADERS
FROM 'https://raw.githubusercontent.com/neo4j-contrib/sandbox-guides/master/legis-graph/data/congresses.csv' AS line
...
USING PERIODIC COMMIT
LOAD CSV WITH HEADERS
FROM 'https://raw.githubusercontent.com/neo4j-contrib/sandbox-guides/master/legis-graph/data/bill_congresses.csv'
AS line
...
USING PERIODIC COMMIT
LOAD CSV WITH HEADERS
FROM 'https://raw.githubusercontent.com/neo4j-contrib/sandbox-guides/master/legis-graph/data/bill_subjects.csv'
AS line
MATCH (bill:Bill { billID: line.billID }),
...
USING PERIODIC COMMIT
LOAD CSV WITH HEADERS
FROM 'https://raw.githubusercontent.com/neo4j-contrib/sandbox-guides/master/legis-graph/data/sponsors.csv'
AS line
MATCH (bill:Bill { billID: line.billID }),
...
USING PERIODIC COMMIT
LOAD CSV WITH HEADERS
FROM 'https://raw.githubusercontent.com/neo4j-contrib/sandbox-guides/master/legis-graph/data/votes.csv'
AS line
MATCH (bill:Bill { billID: line.billID }),
      (legislator:Legislator { bioguideID: line.bioguideID })
...
LOAD CSV WITH HEADERS
FROM 'https://raw.githubusercontent.com/neo4j-contrib/sandbox-guides/master/legis-graph/data/committees-current.csv' AS line
MERGE (c:Committee {thomasID: line.thomasID})
  ON CREATE SET c = line;

LOAD CSV WITH HEADERS
FROM 'https://raw.githubusercontent.com/neo4j-contrib/sandbox-guides/master/legis-graph/data/bill_committees.csv' AS line
...
LOAD CSV WITH HEADERS
FROM 'https://raw.githubusercontent.com/neo4j-contrib/sandbox-guides/master/legis-graph/data/committee-members.csv' AS line
MATCH (c:Committee {thomasID: line.committeeID})
