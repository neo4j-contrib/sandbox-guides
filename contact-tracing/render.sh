...
if [ "$1" == "publish" ]; then
	URL=guides.neo4j.com/sandbox/contact-tracing
	render http://$URL -a csv-url=http://guides.neo4j.com/sandbox/contact-tracing/data/ -a env-training
  ...
  render http://$URL
	...
	URL=localhost:8001/sandbox/contact-tracing
