...
if [ "$1" == "publish" ]; then
  URL=guides.neo4j.com/sandbox/graph-algorithms
  render http://$URL -a csv-url=http://guides.neo4j.com/sandbox/graph-algorithms/data/ -a env-training
  ...
  URL=localhost:8001/sandbox/graph-algorithms
